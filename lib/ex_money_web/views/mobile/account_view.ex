defmodule ExMoney.Web.Mobile.AccountView do
  ...
  def categories_chart_data(categories) do
    parent_categories =
      Enum.map(categories, fn {_id, category} -> category.parent_id end)
    ...
    categories_tree =
      Enum.reduce(categories, %{}, fn {id, category}, acc ->
    ...
    Enum.reduce(categories_tree, [], fn {id, sub_category_ids}, acc ->
      ...
      sub_categories =
        Enum.reduce(sub_category_ids, [], fn sub_category_id, acc ->
        ...
        |> Enum.sort(fn {_id_1, _cat_1, _color_1, _width_1, amount_1},
    ...
    |> Enum.sort(fn {{_id_1, _cat_1, _color_1, _width_1, amount_1}, _sub_categories_1},
