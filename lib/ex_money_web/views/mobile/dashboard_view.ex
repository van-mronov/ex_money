defmodule ExMoney.Web.Mobile.DashboardView do
  ...
  def categories_chart_data(categories) do
    {_category, _color, max} =
      Enum.max_by(categories, fn {_category, _color, amount} -> amount end)
    ...
    |> Enum.sort(fn {_cat_1, _color_1, _width_1, amount_1},
    ...
    cond do
      recent_diff_compare == Decimal.new(1) ->
        "<span style='color:green'>" <>
          recent_diff_str <> currency_label <> "&#x25B2; &nbsp;</span>"
