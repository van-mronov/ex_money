defmodule ExMoney.Web.Mobile.DashboardController do
  ...
  def overview(conn, _params) do
    ...
    new_recent_transactions =
      Enum.filter(transactions, fn tr ->
    ...
    recent_transactions =
      Enum.group_by(transactions, fn transaction ->
        transaction.made_on
      end)
    ...
    accounts =
      ...
      |> Enum.reduce([], fn account, acc ->
        ...
        recent_diff =
          Enum.reduce(new_transactions, Decimal.new(0), fn transaction, acc ->
